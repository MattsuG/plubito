...
<div class="terms_body">
    ...
    7. 「登録実施日時」とは、聞き手の予約リクエストを話し手が承諾することにより決定した、面会またはオンラインで進路情報の提供を受けるシステム上に登録された日時をいいます。話し手または聞き手の都合により、進路情報の提供を受ける実際の日時が変更される場合はありますが、かかる状況においても登録実施日時は変更後の日時ではなく話し手承諾時にシステム上に登録された日時をいいます。<br><br>
    ...
    第5条（登録情報の変更）<br>
    会員は、登録情報に変更があった場合、遅滞なく、真正、最新の情報に登録内容を変更するものとします。<br><br>
