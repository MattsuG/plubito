                ...
                <div class="ibox float-e-margins">
                    ...
                    <div>
                        <div class="ibox-content no-padding border-left-right">
                            ...
                            <img alt="image" class="img-circle" src="{{secure_asset($talk->mentor->profile_picture_path)}}">
                            @else
                        ...
                        <div class="ibox-content profile-content">
                            ...
                            @if ((int)$talk->mentor_id !== (int)Auth::user()->id)
                                <div class="user-button">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <button type="button" class="btn btn-default btn-sm btn-block" onclick="location.href='{{ url('user/message/'.$talk->mentor_id) }}'"><i class="fa fa-envelope"></i> メッセージを送る</button>
                                        </div>
                                    </div>
                                </div>
                            @endif
