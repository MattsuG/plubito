            ...
            @foreach ($talks as $talk)             
                <div class="col-sm-4 pricing-box pricing-box-best wow fadeInDown">
                    <div class="pricing-box-inner">
                        ...
                        <a href="{{ url('mentor/show/'.$talk->talk_id) }}" style="color:#000;text-decoration:none"><img src="img/headphones.jpg" alt="">
                        </div>
                        <h3>{{ $talk->title }}</h3>
                        <h4>概要を記入。文章が長くなった場合はどうなるか。文章が長くなった場合はどうなるか文章が長くなった場合はどうなるか。</h4></a>
                        <div class="pricing-box-features">
                            <ul>
                                <li>{{ $talk->category_id }}</li>
                                <li>{{ $talk->price }}</li></a>
                                <li><a href="/user/message"><button type="button" class="btn btn-default btn-sm btn-block"><i class="fa fa-envelope"></i>メッセージ</button></a></li>                           
                            </ul>
                        </div>
                    </div>
                </div>
